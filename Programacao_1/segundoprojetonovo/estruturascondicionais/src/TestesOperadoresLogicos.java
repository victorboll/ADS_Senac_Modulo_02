...
public class TestesOperadoresLogicos {
	...
	public static void main(String[] args) {
		...
		System.out.println("c é maior que d E b maior que A = " + (c>d&&d>'A'));
		System.out.println("a é igual a b OU b menor que 1 = " + (a==b||b<5));
