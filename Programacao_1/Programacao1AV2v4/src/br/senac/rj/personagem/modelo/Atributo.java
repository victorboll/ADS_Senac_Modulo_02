...
public class Atributo {
	...
	public boolean cadastrarAtributo(int idAtributo, int idPersonagem, String nome, String tipo, String valor, int proficiencia) {
		...
		try {
			...
			if(!rs.isBeforeFirst()) {
				...
				while(rs.next()) {
					...
					this.proficiencia = rs.getInt("proficiencia_atributo");				
				}
				return true;
			}
	...
	public boolean atualizarAtributo(int idAtributo, int idPersonagem, String nome, String tipo, String valor, int proficiencia) {
		if (!consultarAtributo(idAtributo, idPersonagem))
			...
			try {
				...
				String sql = "UPDATE atributos SET nome_atributo=?, tipo_atributo=?, valor_atributo=?, proficiencia_atributo=? WHERE id_atributo=? and id_personagem=?";
				...
				ps.setInt(4, proficiencia);
				ps.setInt(5,  idAtributo);
				ps.setInt(6,  idPersonagem);
