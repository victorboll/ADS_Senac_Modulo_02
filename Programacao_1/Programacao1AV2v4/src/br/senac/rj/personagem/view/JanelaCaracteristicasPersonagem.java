...
public class JanelaCaracteristicasPersonagem {
	...
	public static JFrame criarJanelaCaracteristicasPersonagem() {
		...
		JComboBox<String> dropdownRaca = new JComboBox<>();
		dropdownRaca.setBounds(180, 160, 150, 20);
		dropdownRaca.setEnabled(false);
		dropdownRaca.addItem("");
		dropdownRaca.addItem("Anão");
		dropdownRaca.addItem("Elfo");
		dropdownRaca.addItem("Gnomo");
		dropdownRaca.addItem("Humano");
		dropdownRaca.addItem("Meio-Elfo");
		dropdownRaca.addItem("Meio-Orc");
		janelaCaracteristicasPersonagem.add(dropdownRaca);
		...
		JComboBox<String> dropdownClasse = new JComboBox<>();
		dropdownClasse.setBounds(180, 200, 150, 20);
		dropdownClasse.setEnabled(false);
		dropdownClasse.addItem("");
		dropdownClasse.addItem("Bardo");
		dropdownClasse.addItem("Clérigo");
		dropdownClasse.addItem("Druida");
		dropdownClasse.addItem("Guerreiro");
		dropdownClasse.addItem("Ladino");
		dropdownClasse.addItem("Mago");
		janelaCaracteristicasPersonagem.add(dropdownClasse);
		...
		botaoConsultar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					else{botaoGravar.setEnabled(true);
					...
					dropdownRaca.setSelectedItem(raca);
					dropdownRaca.setEnabled(true);
					dropdownClasse.setSelectedItem(classe);
					dropdownClasse.setEnabled(true);
		...
		botaoGravar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (resposta == JOptionPane.YES_OPTION) {
					...
					String raca = (String) dropdownRaca.getSelectedItem();
					String classe = (String) dropdownClasse.getSelectedItem();
		...
		botaoLimpar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				jTextNivel.setText("");
				jTextNivel.setEnabled(false);
				dropdownRaca.setSelectedItem("");
				dropdownRaca.setEnabled(false);
				dropdownClasse.setSelectedItem("");
				dropdownClasse.setEnabled(false);				
